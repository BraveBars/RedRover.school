...
// private integer variable Side, a getter GetSide() and a setter SetSide(int num) method
// for this property. Actually, getter and setter methods are not the common way to write
// this code in C#. In the next kata of this series,
